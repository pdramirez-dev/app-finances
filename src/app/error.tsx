    ...
    <main className="brand-page-bg min-h-screen px-6 py-8">
      <div className="mx-auto w-full max-w-5xl">
        ...
        <section className="mx-auto mt-20 max-w-2xl brand-panel p-10 text-center text-slate-100">
          ...
          <p className="mt-6 text-xs font-semibold uppercase tracking-[0.22em] text-slate-300">Error</p>
          <h1 className="brand-heading mt-3 text-4xl">Algo salio mal</h1>
          <p className="mt-3 text-sm text-slate-300">
            Ocurrio un error inesperado en la aplicacion. Puedes reintentar o volver al dashboard.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Button type="button" onClick={reset} className="bg-white text-slate-900 hover:bg-slate-100">
              Reintentar
            </Button>
